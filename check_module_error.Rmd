---
title: "check the problems of modules"
output: html_notebook
---

Pre-defined modules: this is a SEIAR model, I and A refer to clinical and sub-clinical passway.

'seed': start the infection from whom
...
init <- init.net(i.num = 1,
                 seed.number=21)  ### seed the infection from node 21

control <- control.net(type = NULL,
                       nsteps = 1500,
                       nsims = 100,
                       ncores = 7,   ## change based on computer 
...
The problem is if you look at the transmission event of node 21( the seed, the epidemic starts from it), it infected node 244 in simulation 84 at time 689, which in this situation is after 28 days. This is wrong as this node 21 should go into R component after 3 days.

```{r}
seed21 <- df_transmat[df_transmat$inf==21,]
seed21 <- seed21[order(seed21$at),]
tail(seed21)
```
